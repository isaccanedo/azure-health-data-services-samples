...
|Exemplo|Descrição|
| --- | --- |
| [Migrar dados de uma API do Azure para servidor FHIR para outra API para servidor FHIR](samples/fhir-to-fhir/api-for-fhir-to-api-for-fhir) | Aplicativo de exemplo para copiar/migrar dados de uma API do Azure para servidor FHIR para outra API do Azure para servidor FHIR. |
